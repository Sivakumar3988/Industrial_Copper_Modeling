...
<div style='text-align:center'>
    <h1 style='color:#90EE90;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:    
    ...
    if submit_button and flag==0:
        ...
        import pickle
        with open(r"C:\Users\hp\Downloads\Datascience Projects\Industrial-CopperProject\source\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r'C:\Users\hp\Downloads\Datascience Projects\Industrial-CopperProject\source\scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\Users\hp\Downloads\Datascience Projects\Industrial-CopperProject\source\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\Users\hp\Downloads\Datascience Projects\Industrial-CopperProject\source\s.pkl", 'rb') as f:
...
with tab2: 
    ...
    if csubmit_button and cflag==0:
        import pickle
        with open(r"C:\Users\hp\Downloads\Datascience Projects\Industrial-CopperProject\source\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r'C:\Users\hp\Downloads\Datascience Projects\Industrial-CopperProject\source\cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\Users\hp\Downloads\Datascience Projects\Industrial-CopperProject\source\ct.pkl", 'rb') as f:
